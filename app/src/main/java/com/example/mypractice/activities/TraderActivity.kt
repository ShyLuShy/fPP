...
// Установка шрифта для текста в action bar
        ...
        val traderHelpView: SubsamplingScaleImageView = findViewById(R.id.shelterHelpView)
        traderHelpView.setImage(ImageSource.resource(R.drawable.traderhelp));
