...
// Установка шрифта для текста в action bar
        ...
        val shelterHelpView: SubsamplingScaleImageView = findViewById(R.id.shelterHelpView)
        shelterHelpView.setImage(ImageSource.resource(R.drawable.shelter_helps));
