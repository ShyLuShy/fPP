...
class InterchangeActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        customView.findViewById<TextView>(R.id.customActionBarTitle).apply {
            text = getText(R.string.interchange)
            typeface = customFont
        }
        ...
        val factoryView: SubsamplingScaleImageView = findViewById(R.id.interchangeView)
        factoryView.setImage(ImageSource.resource(R.drawable.map_intaerchange));
