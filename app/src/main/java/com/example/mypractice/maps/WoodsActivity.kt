...
class WoodsActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val woodsView: SubsamplingScaleImageView = findViewById(R.id.woodsView)
        woodsView.setImage(ImageSource.resource(R.drawable.map_woods));
    }
