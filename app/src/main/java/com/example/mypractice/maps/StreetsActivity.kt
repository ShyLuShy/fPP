...
class StreetsActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val streetsView: SubsamplingScaleImageView = findViewById(R.id.streetsView)
        streetsView.setImage(ImageSource.resource(R.drawable.map_streets));
