...
class LighthouseActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        customView.findViewById<TextView>(R.id.customActionBarTitle).apply {
            text = getText(R.string.lighthouse)
            typeface = customFont
        }
        ...
        val lighthouseView: SubsamplingScaleImageView = findViewById(R.id.lighthouseView)
        lighthouseView.setImage(ImageSource.resource(R.drawable.map_lighthouse));
