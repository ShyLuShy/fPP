...
class ReserveActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val reserveView: SubsamplingScaleImageView = findViewById(R.id.reserveView)
        reserveView.setImage(ImageSource.resource(R.drawable.map_reserve));
